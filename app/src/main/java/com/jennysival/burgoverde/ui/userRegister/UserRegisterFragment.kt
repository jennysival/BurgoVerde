...
import com.jennysival.burgoverde.navigation.UserRegisterNavigatorImpl
...
class UserRegisterFragment : Fragment() {
    ...
    private fun initNavigator() {
        navigator = UserRegisterNavigatorImpl(this)
    }
    ...
    private fun showError() {
        Toast.makeText(requireContext(), "Erro ao registrar, tente novamente!", Toast.LENGTH_LONG).show()
    }
    ...
    private fun userRegisterClick() {
        binding.registerBtn.setOnClickListener {
            ...
            val fields = listOf(
                ...
                Pair(binding.passwordInputLayout, binding.passwordInputLayout.editText?.text.toString()),
                Pair(binding.confirmPasswordInputLayout, binding.confirmPasswordInputLayout.editText?.text.toString()),
            )
